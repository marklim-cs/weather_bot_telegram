...
from app.handlers import start, location_handler, current_weather, todays_weather
...
class Command(BaseCommand):
    ...
    def run_bot(self):
        ...
        application.add_handler(CommandHandler("todays_weather", todays_weather))
        application.add_handler(MessageHandler(filters.TEXT & ~filters.COMMAND, todays_weather))
